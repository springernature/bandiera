  ...
  class API < Sinatra::Base
    ...
    post "/v1/groups/:group_name/features" do |group_name|
      ...
      if feature_name && feature_desc && !feature_enable.nil?
        ...
        raise InvalidParams, "Invalid parameters, required params are { 'feature' => { 'name' => 'FEATURE NAME', 'description' => 'FEATURE DESCRIPTION', 'enabled' => 'TRUE OR FALSE' }  }"
      end
    end
    ...
    put "/v1/groups/:group_name/features/:feature_name" do |group_name, feature_name|
      ...
      if feature_name && feature_desc && !feature_enable.nil?
        ...
        raise InvalidParams, "Invalid parameters, required params are { 'feature' => { 'name' => 'FEATURE NAME', 'description' => 'FEATURE DESCRIPTION', 'enabled' => 'TRUE OR FALSE' }  }, optional params are { 'feature' => { 'group' => 'GROUP NAME' } }"
      end
    end
